#https://github.com/anokhramesh/Calculator_with_Tkinter/blob/main/Calculator_with_tkinter.py
# Calculator Project with Python
from tkinter import*
...
bbtn4 = Button(cal,padx=16,pady=16,bd=8,fg="black",font=('arial',20,'bold'),
